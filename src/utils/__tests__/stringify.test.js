...
describe('stringify()', () => {
  it('should return number converted to a string', () => {
    const value = 1;
    const expected = '1';
    expect(stringify(value, true)).toEqual(expected);
  });
  it('should return Number converted to a string', () => {
  ...
  it('should return string value without leading or trailing whitespaces', () => {
    const value = ' AbC ';
    const expected = 'AbC';
    expect(stringify(value, true)).toEqual(expected);
  });
  it('should return lowercase string value without leading or trailing whitespaces', () => {
    const value = ' AbC ';
    const expected = 'abc';
    expect(stringify(value, false)).toEqual(expected);
  });
  it('should return String value without leading or trailing whitespaces', () => {
