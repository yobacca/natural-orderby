  ...
  describe('sorting flat arrays', () => {
    ...
    describe('unicode', () => {
      ...
      describe('considers locale option', () => {
        const origArray = ['a', 'b', 'ä', 'z'];
        const sortArrayDe = ['a', 'ä', 'b', 'z'];
        const sortArraySv = ['a', 'b', 'z', 'ä'];
        it(`${origArray.toString()} should be returned as ${sortArrayDe.toString()}`, () => {
          expect(baseOrderBy(origArray, [], [], 'de')).toEqual(sortArrayDe);
        });
        it(`${origArray.toString()} should be returned as ${sortArraySv.toString()}`, () => {
          expect(baseOrderBy(origArray, [], [], 'sv')).toEqual(sortArraySv);
        });
      });
    });
